<template>
  ...
  <div class="tps2" v-else>
    <a href="#">
      <div class="info">
        <div class="info">
          <div class="name">
            <span class="ava">
              <img :src="obj.avatar" alt="" width="100%" height="100%">
            </span>
            <span>{{obj.nickname}}</span>
          </div>
          <div class="title">{{obj.title}}</div>
          <div class="desc">{{obj.subTitle}}</div>
          <div class="rcount"><i class="icon"></i><span>{{obj.readCount}}k人看过</span>
          </div>
        </div>
      </div>
      <div class="pic">
